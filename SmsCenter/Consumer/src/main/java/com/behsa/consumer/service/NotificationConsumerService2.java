...
import com.behsa.consumer.confg.KafkaConsumerConfig;
...
public class NotificationConsumerService2 {
    private static KafkaConsumer<String, MessageRequest> consumer;

    public NotificationConsumerService2() {
        consumer = new KafkaConsumer<String, MessageRequest>(KafkaConsumerConfig.consumerConfig());
    ...
    public static void main(String[] args) {
        NotificationConsumerService2 service = new NotificationConsumerService2();
